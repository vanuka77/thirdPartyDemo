...
import utils.silhouette.ExtendedCookieEnv
import javax.inject.Inject

/** Silhouette controller template. */
...
/** Describes silhouette components. */
trait SilhouetteComponents {
  type EnvType = ExtendedCookieEnv
